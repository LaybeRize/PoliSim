...
var replaceMap = map[string]map[string]string{
	...
	"documentCreateVote": {
		...
		"{{/*documentCreateVote-8*/}}Abstimmungsliste &#x1F6C8;":                                                             "Vote List &#x1F6C8;",
		...
		"{{/*documentCreateVote-15*/}}Um Abstimmungen vorzubereiten öffne die Seite unter Dokumente->Abstimmungen verwalten": "To prepare a vote for a document open the page under the menu point Documents->Manage Vote Preparation",
	},
