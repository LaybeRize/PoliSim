...
const (
	...
	DocumentCreatePostHasInvalidVisibility = "chosen visibility for the document is not combinable with the chosen organisation"
	DocumentCreatePostNotAllowedError      = "invalid combination of account and organisation"
	...
	DocumentCreateDiscussionHasInvalidVisibility = "chosen visibility for the discussion is not combinable with the chosen organisation"
	DocumentCreateDiscussionNotAllowedError      = "invalid combination of account and organisation"
	...
	DocumentCreateVoteHasInvalidVisibility = "chosen visibility for the vote is not combinable with the chosen organisation"
	DocumentCreateVoteNotAllowedError      = "invalid combination of account and organisation"
	DocumentCreateVoteHasNoAttachedVotes   = "the document has no attached votes"
	...
	ChatRoomMessageTextarea = "<textarea id=\"text-message\" name=\"text\" rows=\"2\" maxlength=\"2000\" placeholder=\"Write a new message\"></textarea>"
