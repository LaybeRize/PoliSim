...
[![Version](https://img.shields.io/badge/release-vAlpha.6.2-blue)](https://github.com/LaybeRize/PoliSim)
...
See [here](https://github.com/LaybeRize/PoliSim/blob/main/TECH_DETAILS.md) for information on how to build the project and 
other technical and architectural details.